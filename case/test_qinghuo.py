...
def test_qinghuo(sysStore,goodsNo):
    ...
    logs( __name__+"---"+'''查询请货商品入参信息''', data)
    goods=goods_querySimple(token,departmentid,data)
    logs( __name__+"---"+'''查询请货商品响应信息''', goods)
    print('''查询请货商品''',goods)
    #提取货品id
    ...
    logs( __name__+"---"+'''送审请货单入参信息''', data)
    re=requestOrder_submit(departmentid, token,data)
    logs( __name__+"---"+'''送审请货单响应信息''', re)
    print('''送审请货单''',re)
    ...
    logs( __name__+"---"+'''回退送审请货单入参信息''', data)
    re=requestOrder_submit(departmentid, token,data)
    logs( __name__+"---"+'''回退送审请货单响应信息''', re)
    print('''回退送审请货单''',re)
    assert re.get("msg") == "成功", re.get("msg")
    ...
    logs( __name__+"---"+'''删除请货单入参信息''', data)
    re=requestOrder_del(departmentid, token,data)
    print('''删除请货单''',re)
    logs( __name__+"---"+'''删除请货单响应信息''', re)
